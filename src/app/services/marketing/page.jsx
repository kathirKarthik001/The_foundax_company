    ...
    <section>
      <div className={styles.slicer}>
        ...
        <div className={styles.slice}>
          <h4>The seed for your brand's digital presence</h4>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.boxContainer}>
          <div className={styles.box}>
            ...
            <p>Navigate the social landscape effortlessly with our management services. We curate content that sparks conversations, fostering genuine connections and building a thriving online community.</p>
          </div>
          <div className={styles.box}>
